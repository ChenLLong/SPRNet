...
from .regress_point_loss import RegressPointLoss
from .direction_cross_entropy_loss import DirCrossEntropyLoss
...
__all__ = [
    ...
    'weight_reduce_loss', 'weighted_loss', 'RegressPointLoss',
    'DirCrossEntropyLoss'
]
